  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const payload = {
        ...
        appointmentCommunicationPreferences: values.communicationPreference,
        address: {
      ...
      const response = await fetch(`${baseApiUrl}/api/participant/create`, {
        method: "POST",
        headers: {
        ...
        <div>
          ...
          >
            ...
            <section className="mb-8">
              ...
              <Form.Item name={["personalDetails", "birthDate"]}>
                ...
                >
                  ...
                  <Form.Item
                    label="Month"
                    name={["personalDetails", "birthMonth"]}
                  >
                  ...
                  <Form.Item
                    label="Year"
                    name={["personalDetails", "birthYear"]}
                  >
              ...
              <Form.Item
                ...
                name={["personalDetails", "genderIdentity"]}
              >
                <Select allowClear placeholder="" style={{ width: "100%" }}>
              ...
              <Form.Item
                label="Other details"
                name={["personalDetails", "extraInfo"]}
              >
                <TextArea rows={4} />
              </Form.Item>
              <Form.Item
                  ...
                  <>
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Information you add here will be displayed in important
                        places like scheduling appointments.
                      </p>
                    </div>
                  </>
                }
              ...
              <Form.Item
                label="Tags"
                name={["personalDetails", "patientTagIds"]}
              >
                <Select
                  mode="multiple"
                  showSearch
                      ...
                      >
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Allergy type is required",
                            },
                          ]}
                        >
                      ...
                      >
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Intolerance description is required",
                            },
                          ]}
                        >
                          <Input placeholder="Description" />
            ...
            <section className="mb-8">
              ...
              <Space style={{ display: "flex", width: "100%" }}>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Medicare card number is required",
                    },
                  ]}
                >
                  <Input />
              ...
              <h3 className="mb-4 text-md font-medium mt-6">
                Medicare claimant details
              </h3>
                      ...
                      <div key={key} className="border p-4 mb-4 rounded">
                        ...
                        <Form.Item label="Expiry">
                          <Space>
                            <Form.Item
                              {...restField}
                              name={[name, "medicareValidUntilMonth"]}
                              style={{ width: "49%" }}
                              rules={[
                                {
                                  required: true,
                            ...
                            <Form.Item
                              {...restField}
                              name={[name, "medicareValidUntilYear"]}
                              style={{ width: "49%" }}
                              rules={[
                                { required: true, message: "Year is required" },
                              ]}
            ...
            <section className="mb-8">
              ...
              <Form.Item
                ...
                name={["ndisInfo", "fundManagement"]}
              >
                <Select allowClear placeholder="">
                  {fundManagementOptions.map((opt) => (
                    <Option key={opt} value={opt}>
                      {opt}
                    </Option>
                  ))}
            ...
            <section className="mb-8">
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Emergency contact full name is required",
                  },
                ]}
              >
                <Input />
            ...
            <section className="mb-8">
                ...
                label={
                  <>
                    ...
                    <p className="text-xs text-gray-600 mt-1">
                      Information here will be displayed on the invoice under
                      the participant name.
                    </p>
                    <a
                      href="https://support.splose.com/en/articles/4738489-create-send-and-manage-invoices-in-splose#h_6f4486a58f"
                      target="_blank"
              ...
              <Form.Item
                label={
                  <>
                    ...
                    <p className="text-xs text-gray-600 mt-1">
                      Choose to automatically assign a contact as the invoice
                      recipient.
                    </p>
                  </>
                }
              ...
              >
                <Select
                  showSearch
                  placeholder="Start typing to search contact"
                  style={{ width: "100%" }}
                />
              </Form.Item>
              <Form.Item
                label="Default invoice reminder preference"
                name="sendInvoiceReminder"
              >
                <Select>
                  {invoiceReminderOptions.map((opt) => (
                    <Option key={opt} value={opt}>
                      {opt}
                    </Option>
                  ))}
                    ...
                    {fields.map(({ key, name, ...restField }) => (
                      ...
                      >
                        ...
                        >
                          <Select
                            showSearch
                            placeholder="Start typing to search participant"
                          >
                            {/* Options from API */}
                          </Select>
                        </Form.Item>
            ...
            <section className="mb-8">
              ...
              <p className="text-xs text-gray-600 mb-4">
                Select contacts that are associated with the participant to be
                included in different communications.
              </p>
              <Form.Item>
                <Space style={{ display: "flex", width: "100%" }}>
                  <Select
