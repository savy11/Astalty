// app/products/page.js (or pages/products.js in Pages Router)
// Products page with search, sortable table, tags, and pagination.
// Assumptions:
          ...
          <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead className="bg-gray-50">
              <tr>
                ...
                data-tooltip-content={getSortTooltip()} onClick={handleSort}>
