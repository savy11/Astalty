...
const UpdateParticipantForm = () => {
  ...
  useEffect(() => {
    ...
    console.log("Step1", "step1"+participantId);
    ...
    const fetchParticipant = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${baseApiUrl}/api/participants/${participantId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        console.log("Get Gaurav Participant API", participant);
        ...
        form.setFieldsValue({
          ...
          personalDetails: {
            ...
            birthDay: participant.day,
            birthMonth: participant.month,
            birthYear: participant.year,
            sex: participant.sex,
            genderIdentity: participant.genderIdentity,
            pronouns: participant.pronouns,
            occupation: participant.occupation,
            extraInfo: participant.otherDetails,
            patientTagIds: participant.tags || []
          },
          ...
          communicationPreference:
            participant.appointmentCommunicationPreferences,

          addressL1: participant.address?.address1,
          addressL2: participant.address?.address2,
          addressL3: participant.address?.address3,
          city: participant.address?.city,
          state: participant.address?.state,
          postalCode: participant.address?.postalCode,
          country: participant.address?.country,

          privacyPolicy: participant.privacyPolicyStatus
            ? "Accepted"
            : "Rejected",
        ...
        <div>
          <div className="mb-6">
            <div className="flex justify-between items-center">
              <h1 className="text-xl font-semibold">Update participant</h1>
              <Space>
